...
def Admin_Space():
    ...
    def Ad_Screen():
        ...
        def PAttend():
            ...
            label.grid(row=0, columnspan=5)
            # create Treeview with 6 columns
            cols = ('Sno','Name','Password','Position','Specialization','Tenure','Blood Group')
...
def main():
    ...
    button1 = tk.Button(m, text = "Staff", width=20, height= 2, command = staffentry, bg='#2A313C')
